    ...
    <div className={className}>
      ...
      <div className="mt-2">
        <input
          ...
          className={`block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ${errorMessage ? "ring-red-500" : "ring-gray-300"} placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-green-600 sm:text-sm sm:leading-6 p-2 focus:outline-0 disabled:cursor-not-allowed disabled:bg-gray-50 disabled:text-gray-500 disabled:ring-gray-200 hover:drop-shadow-sm`}
          onChange={onChange}
          value={value}
          {...props}
        />
